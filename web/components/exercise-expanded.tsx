// will be a card component with a dialouge box to open larger
// more of a horizontal orentation with seperatiors breaking uop the info
// button on the side to expland and learn more
// badges to show options primary seconday)
// dont show all the data in the preview, name, description, primary, secondary,
